...
from caelestia.subcommands import clipboard, emoji, pip, record, scheme, screenshot, shell, toggle, wallpaper, keybinds
...
def parse_args() -> (argparse.ArgumentParser, argparse.Namespace):
    ...
    # Create parser for keybindings opts
    keybinds_parser = command_parser.add_parser("keybinds", help="open keybinds")
    keybinds_parser.set_defaults(cls=keybinds.Command)
    keybinds_parser.add_argument("-p", "--picker", action="store_true", help="open the keybinds picker")
    keybinds_parser.add_argument("-g", "--generate", action="store_true", help="generate keybinds.txt file anew")
